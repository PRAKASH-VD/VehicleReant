...
const getNavigation = (user) => {
    ...
    return [
     ...
     return [
         ...
         {name:'Vehicles', href:'/dashboard/vehicles/pages/1', current: false},
         {name:'Cart', href:'/dashboard/cart', current: false},
         {name:'Bookings', href:'/dashboard/bookings', current: false},
     ]
    }else if (user.role ==='admin') {
        return [
            {name :'Admin Dashboard', href:'/admin/dashboard', current: true},
            {name :'Vehicles', href:'/admin/vehicles', current: false},
